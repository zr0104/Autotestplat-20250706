...
function addParam(){
     ...
     addParamType.addEventListener('change', function() {
         if (this.value == '认证') {
             ...
             document.getElementById('addParamUsername').querySelector('.input-group-text').innerHTML = '<span style="color: red;">* </span>' + '登录接口账号';
             addParamPassword.style.display=''
             document.getElementById('addParamPassword').querySelector('.input-group-text').innerHTML = '<span style="color: red;">* </span>' + '登录接口密码';
             addParamLeftMatch.style.display=''
             document.getElementById('addParamLeftMatch').querySelector('.input-group-text').innerHTML = '<span style="color: red;">* </span>' + 'token左匹配';
             addParamRightMatch.style.display=''
             document.getElementById('addParamRightMatch').querySelector('.input-group-text').innerHTML = '<span style="color: red;">* </span>' + 'token右匹配';
         ...
         } else if(this.value == 'Web设置'){
             addParamValue.style.display=''
             addParamDesc.style.display=''
             document.getElementById('addParamValue').querySelector('.input-group-text').innerHTML = '<span style="color: red;">* </span>' + 'Web自动化框架';
...
function modParam(){
     ...
     modParamType.addEventListener('change', function() {
         if (this.value == '认证') {
             ...
             document.getElementById('modParamUsername').querySelector('.input-group-text').innerHTML = '<span style="color: red;">* </span>' + '登录接口账号';
             modParamPassword.style.display=''
             document.getElementById('modParamPassword').querySelector('.input-group-text').innerHTML = '<span style="color: red;">* </span>' + '登录接口密码';
             modParamLeftMatch.style.display=''
             document.getElementById('modParamLeftMatch').querySelector('.input-group-text').innerHTML = '<span style="color: red;">* </span>' + 'token左匹配';
             modParamRightMatch.style.display=''
             document.getElementById('modParamRightMatch').querySelector('.input-group-text').innerHTML = '<span style="color: red;">* </span>' + 'token右匹配';
         } else if(this.value == 'App设置'){
             modParamValue.style.display=''
             modParamDesc.style.display=''
             ...
             modParamValue.style.display=''
             modParamDesc.style.display=''
             document.getElementById('amodParamValue').querySelector('.input-group-text').innerHTML = '<span style="color: red;">* </span>' + 'Web自动化框架';
             addParamUsername.style.display='None'
             addParamPassword.style.display='None'
             addParamLeftMatch.style.display='None'
             addParamRightMatch.style.display='None'
        ...
        success: function (result) {
            ...
            for(let i = 0; i < inputFields.length; i++){
                ...
                if(temp.tagName == "INPUT"){
                    ...
                    else if(selectedRow.children[modRowIndex[i]].innerText=="Web设置"){
                        modParamValue.style.display=''
                        modParamDesc.style.display=''
                        document.getElementById('modParamValue').querySelector('.input-group-text').innerHTML = '<span style="color: red;">* </span>' + 'Web自动化框架';
                        modParamUsername.style.display='None'
                        modParamPassword.style.display='None'
                        modParamLeftMatch.style.display='None'
                        modParamRightMatch.style.display='None'
