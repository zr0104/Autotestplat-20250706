...
delURL = 'aitestcasetemp/delAitestcase/'
delFieldNames = ['ai_testcase_code']


testcaseDetailRUL = 'getAitestcaseDetail/'
getSearchSelectURL = ''
getSelectURL = 'aitestcasetemp/getAiOptions/'
searchableTableColumns = [1,2,3]

tableURL = 'aitestcasetemp/getTableData/'
table = 0
tableButtonOperation = "<a href=\"#\" class=\"#\" onclick=\"showMod(this)\"> <span class=\"badge badge-success \" style=\"width: 60px;font-size: 12px\">采纳保存</span> </a>" +
                       "<a href=\"#\" class=\"#\" onclick=\"showDelModal(this)\"> <span class=\"badge badge-danger \" style=\"width: 50px;font-size: 12px\">不采纳</span> </a>"
