...
addFieldNames = ['ai_testcase_name', 'ai_testcase_result',  'ai_testcase_step', 'ai_testcase_stepname', 'ai_testcase_expect_value', 'ai_testcase_real_value','ai_testcase_step_result','ai_testcase_code_order']
addRequiredFields = [0,1, 2, 3, 4,5,6,7]

modURL = 'aitestcase/modAitestcase/'
modFieldNames = ['ai_testcase_name', 'ai_testcase_result',  'ai_testcase_step', 'ai_testcase_stepname', 'ai_testcase_expect_value', 'ai_testcase_real_value','ai_testcase_step_result','ai_testcase_code_order']
modRequiredFields = [0, 1, 2, 3,4,5,6,7]
modRowIndex = [0, 1, 2, 3]

copyURL = 'aitestcase/copyAitestcase/'
copyFieldNames = ['ai_testcase_name', 'ai_testcase_result',  'ai_testcase_step', 'ai_testcase_stepname', 'ai_testcase_expect_value', 'ai_testcase_real_value','ai_testcase_step_result','ai_testcase_code_order']
copyRequiredFields = [0, 1, 2, 3,4,5,6,7]
copyRowIndex = [0, 1, 2, 3]

delURL = 'aitestcase/delAitestcase/'
delFieldNames = ['id']

runAppTestcaseBycode = 'aitestcase/run_aitestcase/'
runAppTestcaseByProduct = 'aitestcase/runAllTestcase/'
...
table = 0
tableButtonOperation = "<a href=\"#\" class=\"#\" onclick=\"run_aitestcase_bycode(this)\"> <span class=\"badge badge-success \" style=\"width: 40px;font-size: 12px\">执行</span> </a>" +
